	...
	public class NativeFunctions
	{
		...
		public static void cppSetCreateSubstanceGraphCallbackEditorPtr(IntPtr fp)
		{
			...
			cppSetCreateSubstanceGraphCallbackEditorPtrDelegate function = DLLHelpers.GetFunction(
																								myName, typeof(cppSetCreateSubstanceGraphCallbackEditorPtrDelegate)) as
																				cppSetCreateSubstanceGraphCallbackEditorPtrDelegate;
...
#if IMPORT_DYNAMIC
		public delegate int cppLoadSubstanceDelegate(string pAssetPath, IntPtr array, int size,
													IntPtr assetCtx, IntPtr substanceObject,
													uint[] graphIndices, string[] graphPrototypeNames, string[] graphLabels,
													int[] graphFormats, int[] normalFormats, uint numGraphIndices,
													int rawOverride, int pPipeline);

		public static int cppLoadSubstance(string pAssetPath, IntPtr array, int size, IntPtr assetCtx, IntPtr substanceObject,
											uint[] graphIndices, string[] graphPrototypeNames, string[] graphLabels,
											int[] graphFormats, int[] normalFormats, uint numGraphIndices,
											int rawOverride, int pPipeline)
		{
...
#if IMPORT_DYNAMIC // not used anymore
		public delegate IntPtr cppGetOutputIdentifierFromHashDelegate(string pAssetPath, uint outputHash);

		public static IntPtr cppGetOutputIdentifierFromHash(string pAssetPath, uint outputHash)
		{
			string myName = MethodBase.GetCurrentMethod().Name;
			if (DLLHelpers.DllHandle == IntPtr.Zero)
			{
			...
			cppGetOutputIdentifierFromHashDelegate function = DLLHelpers.GetFunction(
																					myName, typeof(cppGetOutputIdentifierFromHashDelegate)) as
																cppGetOutputIdentifierFromHashDelegate;
...
#if IMPORT_DYNAMIC // not used anymore
		public delegate bool cppIsImageOutputFromHashDelegate(string pAssetPath, uint outputHash);

		public static bool cppIsImageOutputFromHash(string pAssetPath, uint outputHash)
		{
			string myName = MethodBase.GetCurrentMethod().Name;
			if (DLLHelpers.DllHandle == IntPtr.Zero)
			{
		...
		public static IntPtr cppGetOutputChannelStrFromHash(string pAssetPath, uint outputHash)
		{
			...
			cppGetOutputChannelStrFromHashDelegate function = DLLHelpers.GetFunction(
																					myName, typeof(cppGetOutputChannelStrFromHashDelegate)) as
																cppGetOutputChannelStrFromHashDelegate;
		...
		public static int cppGetNumberOfDuplicatedGraphs(IntPtr graphHandle)
		{
			...
			cppGetNumberOfDuplicatedGraphsDelegate function = DLLHelpers.GetFunction(
																					myName, typeof(cppGetNumberOfDuplicatedGraphsDelegate)) as
																cppGetNumberOfDuplicatedGraphsDelegate;
